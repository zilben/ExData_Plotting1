...
##PlotB
with(HPCdata3,plot(Time,Sub_metering_1,
                   type = "l",
                   xlab = "", 
                   ylab = "Energy sub metering"))
lines(HPCdata3$Time,HPCdata3$Sub_metering_2, col = "red")
lines(HPCdata3$Time,HPCdata3$Sub_metering_3, col = "blue")
legend("topright",
       lty = 1, pch = NA, 
       bty = "n",
       cex=1.1,
...
##PlotC
with(HPCdata3,plot(Time,Voltage, 
                   type = "l",
                   xlab = "", 
                   ylab = "Global Active Power (kilowatts)"))
##PlotD
with(HPCdata3,plot(Time,Global_reactive_power, 
                   type = "l",
                   xlab = "", 
                   ylab = "Global Active Power (kilowatts)"))
